...
class SwinMLPBlock(nn.Module):
    def __init__(self,
        ...
        self.spatial_mlp = nn.Conv1d(self.num_heads * self.window_size[0] ** 2,
                                     self.num_heads * self.window_size[0] ** 2,
                                     kernel_size=1,
    ...
    def forward_part1(self, x):
        ...
        spatial_mlp_windows = spatial_mlp_windows.reshape(-1, window_size[0] * window_size[1] * window_size[2], c)
        spatial_mlp_windows = spatial_mlp_windows.reshape(-1, window_size[0], window_size[1], window_size[2], c)
        shifted_x = window_reverse(spatial_mlp_windows, window_size, dims)  # B H' W' C
